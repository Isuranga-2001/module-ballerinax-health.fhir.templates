...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function post fhir/r4/Practitioner (r4:FHIRContext fhirContext, Practitioner procedure) returns Practitioner|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
